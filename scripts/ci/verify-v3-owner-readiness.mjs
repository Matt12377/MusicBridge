...
function validateControlIdentity(status, wave) {
  ...
  check(gates && gates.readinessControl === READINESS_CONTROL && gates.externalEvidenceProfiles === 'REAL_INPUT_PREPARED_REAL_LOGIC_REAL_ROON_HARDWARE_PENDING', 'CONTROL_STATE')
