...
const controlStatus = {
  v3Development: {
    ...
    state: 'no-device-control-main-green-hardware-independent-r2-final-red-objects-measure-window06-software-pass-queued-stop-joint-external-pending',
    ...
    gates: {
      ...
      capacityAuthority: 'OBJECTS_MEASURE_WINDOW06_SOFTWARE_PASS_QUEUED_STOP_JOINT_PENDING',
