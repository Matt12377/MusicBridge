...
const controlStatus = {
  v3Development: {
    ...
    state: 'no-device-control-main-green-hardware-independent-r2-final-red-objects-measure-window06-software-pass-queued-stop-window02-terminal-prechild-nonreplay-successor-exact75-not-issued-formal-not-run-joint-budget-software-green-formal-not-run-external-pending',
    ...
    gates: {
      ...
      capacityAuthority: 'OBJECTS_MEASURE_WINDOW06_SOFTWARE_PASS_QUEUED_STOP_WINDOW02_TERMINAL_PRECHILD_NONREPLAY_SUCCESSOR_EXACT75_NOT_ISSUED_FORMAL_NOT_RUN_JOINT_BUDGET_SOFTWARE_GREEN_FORMAL_NOT_RUN',
...
test('STATUS设备与外部门状态不能和readiness清单互相矛盾', () => {
  for (const edit of [
    ...
    value => { value.v3Development.task078SoftwareCheckpoints.capacityQueuedStopControlPlane.rootClosure.exact = 74 },
    value => { value.v3Development.task078SoftwareCheckpoints.capacityQueuedStopControlPlane.rootClosure.exact = 76 },
