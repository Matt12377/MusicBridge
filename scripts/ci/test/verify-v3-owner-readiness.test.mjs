...
const controlStatus = {
  v3Development: {
    ...
    state: 'no-device-control-main-green-hardware-independent-r2-final-red-objects-measure-timeout-partial-preserved-external-not-run',
    ...
    gates: {
      ...
      capacityAuthority: 'OBJECTS_MEASURE_WINDOW01_EXECUTION_TIMEOUT_PARTIAL_PRESERVED_DIAGNOSIS_REQUIRED',
