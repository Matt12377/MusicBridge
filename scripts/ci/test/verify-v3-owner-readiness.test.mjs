...
const controlStatus = {
  v3Development: {
    ...
    state: 'no-device-control-main-green-hardware-independent-r2-final-red-objects-generation-pass-measure-issuer-green-external-not-run',
    ...
    gates: {
      ...
      capacityAuthority: 'OBJECTS_GENERATION_PASS_MEASURE_ISSUER_GREEN_FRESH_MEASURE_AUTHORITY_REQUIRED',
...
test('STATUS设备与外部门状态不能和readiness清单互相矛盾', () => {
  for (const edit of [
    ...
    value => { value.v3Development.task078SoftwareCheckpoints.capacityMeasureWindowIssuer.freshMeasureAuthorityIssued = true },
