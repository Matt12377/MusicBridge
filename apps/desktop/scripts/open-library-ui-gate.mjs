    ...
    try {
      ...
      for (const value of ['light','dark']) {
        ...
        for (const [width,height] of [[1980,1080],[1440,819],[720,640]]) {
          ...
          if (layout.timelineWidth>360 || !layout.timelineCentered || !layout.settingsReachable || !layout.fits || layout.overlaps || layout.qualityHeight !== layout.zoneHeight) throw Error(JSON.stringify(layout))
