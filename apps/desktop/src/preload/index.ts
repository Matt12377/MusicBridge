...
contextBridge.exposeInMainWorld(
  ...
  createPreloadApi(
    ...
    },
    {
      ...
      chooseArchiveRoot: commandId => ipcRenderer.invoke('recordingArchive:choose', commandId),
      initializeArchiveRoot: request => ipcRenderer.invoke('recordingArchive:initialize', request),
      revokeArchiveRoot: request => ipcRenderer.invoke('recordingArchive:revokeRoot', request),
      previewArchive: request => ipcRenderer.invoke('recordingArchive:preview', request),
      startArchive: request => ipcRenderer.invoke('recordingArchive:start', request),
      ...
      cancelArchive: request => ipcRenderer.invoke('recordingArchive:cancel', request),
      resumeArchive: request => ipcRenderer.invoke('recordingArchive:resume', request),
