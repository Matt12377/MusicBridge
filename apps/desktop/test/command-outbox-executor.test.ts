...
const nativeCases: { command: CommandOutboxRequest['command']; payload: object; receipt: string; field: string; write: string; result: unknown; title: string; properties: string[] }[] = [
  ...
  { command: 'spreadsheetImports.chooseWorkbook', payload: { commandId }, receipt: 'spreadsheetImports.workbookReceipt', field: 'source', write: 'spreadsheetImports.registerWorkbook', result: { id: entityId, workbookHash: 'a'.repeat(64), displayName: '合成.xlsx', fileFormat: 'xlsx', parserVersion: 'sheetjs-ce-0.20.3', dateSystem: '1900', byteLength: 1024, createdAt: timestamp, sheets: [{ name: '库存', rowCount: 2, nonEmptyCellCount: 6 }] }, title: '选择 Excel 工作簿', properties: ['openFile'] },
]
