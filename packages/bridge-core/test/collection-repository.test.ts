...
test('v1 库存迁移保留全部账本和实体；迁移失败仍保留 v1 可恢复状态', async t => {
  ...
  db.exec('DROP TABLE preparation_workspaces; DROP TABLE preparation_jobs; DROP TABLE preparation_destinations; DROP TABLE preparation_ledger; DROP TABLE layout_versions; DROP TABLE master_versions; DROP TABLE version_jobs; DROP TABLE version_ledger; DROP TABLE media_reservations; DROP TABLE media_plans; DROP TABLE media_ledger; DROP TABLE draft_source_links; DROP TABLE source_bindings; DROP TABLE source_roots; DROP TABLE source_jobs; DROP TABLE source_ledger; DROP TABLE master_drafts; DROP TABLE master_drafts_ledger; DROP TABLE physical_digital_links; DROP TABLE physical_digital_absence; DROP TABLE digital_albums; DROP TABLE physical_links_ledger; DROP TABLE music_photos; DROP TABLE legacy_recording_content; DROP TABLE music_releases; DROP TABLE music_ledger; DROP TABLE collection_featured_photos; DROP TABLE collection_photos; PRAGMA user_version=1');
  ...
  try { assert.equal(check.prepare('PRAGMA user_version').get()?.user_version, 9); assert.deepEqual(check.prepare('SELECT * FROM inventory_ledger ORDER BY rowid').all(), ledger); }
  finally { check.close(); }
});
...
test('schema 4 草稿迁移中断完整回滚，成功后原音乐与 Roon 关系不变', async t => {
  ...
  const db = new DatabaseSync(filePath); db.exec('DROP TABLE preparation_workspaces; DROP TABLE preparation_jobs; DROP TABLE preparation_destinations; DROP TABLE preparation_ledger; DROP TABLE layout_versions; DROP TABLE master_versions; DROP TABLE version_jobs; DROP TABLE version_ledger; DROP TABLE media_reservations; DROP TABLE media_plans; DROP TABLE media_ledger; DROP TABLE draft_source_links; DROP TABLE source_bindings; DROP TABLE source_roots; DROP TABLE source_jobs; DROP TABLE source_ledger; DROP TABLE master_drafts; DROP TABLE master_drafts_ledger; PRAGMA user_version=4'); db.close();
...
test('v5 源证据迁移失败回滚；重试保留草稿及所有旧账本', async t => {
  ...
  const db = new DatabaseSync(filePath); db.exec('DROP TABLE preparation_workspaces; DROP TABLE preparation_jobs; DROP TABLE preparation_destinations; DROP TABLE preparation_ledger; DROP TABLE layout_versions; DROP TABLE master_versions; DROP TABLE version_jobs; DROP TABLE version_ledger; DROP TABLE media_reservations; DROP TABLE media_plans; DROP TABLE media_ledger; DROP TABLE draft_source_links; DROP TABLE source_bindings; DROP TABLE source_roots; DROP TABLE source_jobs; DROP TABLE source_ledger; PRAGMA user_version=5');
...
test('分面迁移从 schema 6 原子升级，失败不改变草稿与库存，两个账本不可改写', async t => {
  ...
  repository.close();
  const db = new DatabaseSync(filePath); db.exec('DROP TABLE preparation_workspaces; DROP TABLE preparation_jobs; DROP TABLE preparation_destinations; DROP TABLE preparation_ledger; DROP TABLE layout_versions; DROP TABLE master_versions; DROP TABLE version_jobs; DROP TABLE version_ledger; DROP TABLE media_reservations; DROP TABLE media_plans; DROP TABLE media_ledger; PRAGMA user_version=6'); db.close();
